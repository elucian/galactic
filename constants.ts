...
// CHECKPOINT: Beta 11
// VERSION: Beta 11 - Reference Snapshot - Code Integrity Preserved
...
export const SHIPS: ExtendedShipConfig[] = [
  ...
  { id: 'enterprise', name: 'USS Sovereign', description: 'Saucer section.', price: 230000, maxEnergy: 20000, maxCargo: 200, speed: 5.5, shape: 'mine-layer', canLayMines: true, defaultColor: '#e2e8f0', engines: 2, defaultGuns: 1, noseType: 'rounded', wingConfig: 'balanced', gunMount: 'hull', wingStyle: 'parenthesis', wingCurve: 'neutral', hullShapeType: 'oval', extraDetail: 'antenna', maxFuel: 11.0 },
  { id: 'dreadnought', name: 'Void Wraith', description: 'Stealth destroyer.', price: 380000, maxEnergy: 25000, maxCargo: 1000, speed: 3.5, shape: 'stealth', canLayMines: true, defaultColor: '#1e1e24', engines: 2, defaultGuns: 2, noseType: 'flat', wingConfig: 'front-heavy', gunMount: 'strut', wingStyle: 'cylon', wingCurve: 'backward', hullShapeType: 'angled-flat', extraDetail: 'none', maxFuel: 12.0 },
