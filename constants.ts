...
export const SHIPS: ExtendedShipConfig[] = [
  ...
  { id: 'dreadnought', name: 'Void Wraith', description: 'Stealth destroyer with external pulse cannons.', price: 380000, maxEnergy: 1200, maxCargo: 1000, speed: 3.5, shape: 'stealth', canLayMines: true, defaultColor: '#1e1e24', engines: 2, defaultGuns: 2, noseType: 'flat', wingConfig: 'front-heavy', gunMount: 'strut', wingStyle: 'cylon', wingCurve: 'backward', hullShapeType: 'angled-flat', extraDetail: 'none', maxFuel: 9.0 },
